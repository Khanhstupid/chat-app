                                                                ...
                                                                <div>
                                                                    ...
                                                                    <div>
                                                                        <dt
                                                                            ...
                                                                            "
                                                                        >
                                                                           {data.isGroup ? `Created At` : `Joined` } 
                                                                        </dt>
                                                                        <dd
                                                                            className="
                                                                                mt-1 
                                                                            ...
                                                                            "
                                                                        >   
                                                                    <time dateTime={data.isGroup ? data.createdAt?.toString() : joinedDate?.toString()}>
                                                                        {data.isGroup ? data.createdAt?.toString() : joinedDate?.toString()}
                                                                    </time>
                                                                        </dd>
                                                                    </div>
